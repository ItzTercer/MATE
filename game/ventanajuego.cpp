...
VentanaJuego::VentanaJuego() {
    setWindowTitle("MATE: Aventura Grafica");
    resize(940, 640);
    setStyleSheet("QMainWindow{background:#11151f;}");
...
QWidget *VentanaJuego::crearMenu() {
    ...
    auto *titulo = new QLabel("MATE: Aventura Grafica");
...
void VentanaJuego::mostrarMapa() {
    ...
    for (int m = 1; m <= TOTAL_MUNDOS; ++m) {
        ...
        btn->setStyleSheet(QString(
            ...
            "QPushButton:hover{background:#37527f;}").arg(color));
