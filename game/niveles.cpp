...
/*
 * Definicion de los niveles del juego "MATE: Aventura Grafica".
 * Cada mundo introduce un tipo de funcion del curriculum de secundaria
 * y mezcla retos de construccion (Atrapa la Curva) con preguntas (Quiz).
 */
QVector<NivelDef> construirNiveles() {
    QVector<NivelDef> v;

    // ===================== MUNDO 1: RECTAS (y = ax + b) =====================
    {
        NivelDef n;
    ...
    // ============== MUNDO 4: LOG / EXPONENCIAL (y = a·b^x + c) ==============
    {
        NivelDef n;
