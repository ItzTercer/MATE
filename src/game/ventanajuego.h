...
/*
 * VentanaJuego — ventana principal de "MATE: Aventura Grafica".
 * Maneja la navegacion (menu, mapa de mundos, selector, nivel) y el estado
 * del jugador: puntaje, vidas y mundos desbloqueados.
 */
...
private:
    ...
    QWidget *paginaDinamica_ = nullptr;   // mapa/selector/nivel actual
